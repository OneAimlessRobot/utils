...
file_extensions="{*.{md,sh,webp},.git*e*}"
...
cp -rf {*.{md,sh,webp},.git*e*} "${backup_one}/emotionstreamer_pub" &&
cp -rf code "${backup_one}/emotionstreamer_pub" &&
cp -rf {*.{md,sh,webp},.git*e*} "${backup_one}/emotionstreamer_priv" &&
cp -rf code "${backup_one}/emotionstreamer_priv" &&
cp -rf {*.{md,sh,webp},.git*e*} "${backup_two}/emotionstreamer_pub" &&
cp -rf code "${backup_two}/emotionstreamer_pub" &&
cp -rf {*.{md,sh,webp},.git*e*} "${backup_two}/emotionstreamer_priv" &&
cp -rf code "${backup_two}/emotionstreamer_priv" &&
cp -rf {*.{md,sh,webp},.git*e*} "${backup_two}/emotionstreamer" &&
cp -rf code "${backup_two}/emotionstreamer" &&
cp -rf {*.{md,sh,webp},.git*e*} "${backup_three}/emotionstreamer_pub" &&
cp -rf code "${backup_three}/emotionstreamer_pub" &&
cp -rf {*.{md,sh,webp},.git*e*} "${backup_three}/emotionstreamer_priv" &&
cp -rf code "${backup_three}/emotionstreamer_priv" &&
cp -rf {*.{md,sh,webp},.git*e*} "${backup_three}/emotionstreamer" &&
